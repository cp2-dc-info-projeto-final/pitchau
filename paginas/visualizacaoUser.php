      ...
      <?php
        ...
        if (!empty($usuarios)) {
          foreach ($usuarios as $usuario) {
            ...
            echo '<td>';
            echo '<button class="card__btn" onclick="exibirElementosEmail()">Alterar email</button>';
...
<div class="alinhamento">
  <div class="card card_altera_email card_email">
    ...
    <form id="edit-form" class="form" method="POST" action="../php/edita_usuario.php">
      <div class="form-container">
        <input type="hidden" name="action" value="edit">
        <input type="hidden" name="id" id="edit-id">
        <input type="email" name="new_name" id="edit-new-name" placeholder="Email">
