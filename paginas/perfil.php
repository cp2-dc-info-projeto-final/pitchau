...
?>
>>>>>>> 9edb45f368ff9fc357508476dc35d994a3a6ff81
        ...
        <li class="nav-item dropdown">
          ...
          <script>
            ...
            if(menulevel == '1'){
              ...
              menu = '<li><a class="dropdown-item" href="perfil.php">Perfil</a></li><li></li><li><a class="dropdown-item" href="produtos_comprados.php">Prod Comprado</a></li><li><a class="dropdown-item" href="../php/logout.php">Logout</a></li>';
            }
            else if(menulevel == '3'){
